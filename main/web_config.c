...
static esp_err_t config_page_handler(httpd_req_t *req)
{
    ...
    snprintf(chunk, sizeof(chunk),
        ...
        "<form method='POST' action='/save_sim_config'>"
        "<div class='sensor-card'>"
        ...
        "<input type='text' id='sim_apn' name='sim_apn' value='%s' placeholder='internet' maxlength='63' style='width:100%%;max-width:400px;padding:8px'><br>"
        "<small style='color:#666'>Your carrier's Access Point Name (e.g., \"internet\", \"hologram\")</small><br><br>"
    ...
    snprintf(chunk, sizeof(chunk),
        ...
        "<form method='POST' action='/save_sd_config'>"
        "<div class='sensor-card'>"
    ...
    snprintf(chunk, sizeof(chunk),
        ...
        "<form method='POST' action='/save_rtc_config'>"
        "<div class='sensor-card'>"
