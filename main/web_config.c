...
".card label,.sensor-card label{display:block;text-align:left;color:var(--primary-800);font-weight:var(--weight-semibold);margin-bottom:var(--space-xs)}"
...
".input-large{width:100%;max-width:300px}"
".input-medium{width:100%;max-width:200px}"
".input-small{width:100%;max-width:120px}"
".input-tiny{width:100%;max-width:80px}"
".required-field{border:2px solid #dc3545;padding:8px;border-radius:4px}"
".optional-field{border:1px solid #ddd;padding:8px;border-radius:4px}"
".sensor-form-grid{display:grid;grid-template-columns:1fr;gap:10px;margin-bottom:10px}"
".sensor-actions{display:flex;flex-direction:column;gap:8px;margin-top:10px}"
".sensor-actions button{width:100%;min-height:44px;padding:12px;margin:5px 0}"
